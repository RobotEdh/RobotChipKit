...

{
    ...
    BOOL  intDisabled;
        ...
        UINT32 startTickCount;
        const UINT32 maxAllowedTicks = TICKS_PER_SECOND / 2;  // KRV, added to the throw INT time when failing
    #elif defined(WF_DEBUG)
        UINT32 startTickCount;
        UINT32 maxAllowedTicks;
   #endif
    ...
    */
    ...
    #if defined(__Digilent_Build__)
        // KRV added, in the past this would occassionally fail and assert, what we want
        // to do is fake an INT and make sure we didn't miss an INT
